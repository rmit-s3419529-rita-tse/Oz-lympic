...
public class GameDB {
	...
	public GameDB() {
		...
		part.add(new Swimmer("Oz1001", "swimmer", "A. Edwin", 30, "VIC",0));
		part.add(new Swimmer("Oz1002", "swimmer", "M. McKendrick", 34, "NSW",0));
		part.add(new Swimmer("Oz1003", "swimmer", "C. Brown", 54, "SA",0));
		part.add(new Swimmer("Oz1004", "swimmer", "Y. Lee", 42, "NSW",0));
		part.add(new Swimmer("Oz1005", "swimmer", "S. Fary", 36, "NT",0));
		part.add(new Swimmer("Oz1006", "swimmer", "M. Phelps", 22, "TAS",0));
		part.add(new Swimmer("Oz1007", "swimmer", "D. Shakes", 43, "QLD",0));
		part.add(new Swimmer("Oz1008", "swimmer", "J. Mahadevan", 18, "WA",0));
		part.add(new Swimmer("Oz1009", "swimmer", "M. Jasmine", 23, "WA",0));
		part.add(new Swimmer("Oz1010", "swimmer", "A. Allison", 40, "QLD",0));
		part.add(new Swimmer("Oz1011", "swimmer", "J. Savannah", 18, "TAS",0));
		part.add(new Swimmer("Oz1012", "swimmer", "R. Isabel", 31, "QLD",0));
		part.add(new Sprinter("Oz2001", "sprinter", "U. Bolt", 20, "VIC",0));
		part.add(new Sprinter("Oz2002", "sprinter", "S. Pearson", 34, "WA",0));
		part.add(new Sprinter("Oz2003", "sprinter", "F. Gump", 33, "QLD",0));
		part.add(new Sprinter("Oz2004", "sprinter", "R. Fenty", 41, "NT",0));
		part.add(new Sprinter("Oz2005", "sprinter", "S. Germanotta", 38, "TAS",0));
		part.add(new Sprinter("Oz2006", "sprinter", "C. Freeman", 44, "NSW",0));
		part.add(new Sprinter("Oz2007", "sprinter", "J. Ross", 52, "NT",0));
		part.add(new Sprinter("Oz2008", "sprinter", "P. Johnson", 23, "SA",0));
		part.add(new Sprinter("Oz2009", "sprinter", "B. Anna", 18, "NT",0));
		part.add(new Sprinter("Oz2010", "sprinter", "C. Zoe", 24, "SA",0));
		part.add(new Sprinter("Oz2011", "sprinter", "F. Natalie", 42, "NT",0));
		part.add(new Sprinter("Oz2012", "sprinter", "W. Kylie", 33, "WA",0));
		part.add(new Cyclist("Oz3001", "cyclist", "C. Evans", 24, "VIC",0));
		part.add(new Cyclist("Oz3002", "cyclist", "L. Armstrong", 25, "WA",0));
		part.add(new Cyclist("Oz3003", "cyclist", "H. Huntley", 24, "SA",0));
		part.add(new Cyclist("Oz3004", "cyclist", "P. Gilert", 27, "VIC",0));
		part.add(new Cyclist("Oz3005", "cyclist", "A. Chan", 25, "NSW",0));
		part.add(new Cyclist("Oz3006", "cyclist", "R. Tsang", 34, "NT",0));
		part.add(new Cyclist("Oz3007", "cyclist", "E. Kawamura", 32, "QLD",0));
		part.add(new Cyclist("Oz3008", "cyclist", "B. Hayes", 25, "TAS",0));
		part.add(new Cyclist("Oz3009", "cyclist", "K. Gavin", 27, "SA",0));
		part.add(new Cyclist("Oz3010", "cyclist", "T. Daniel", 20, "NT",0));
		part.add(new Cyclist("Oz3011", "cyclist", "E. Kawamura", 34, "VIC",0));
		part.add(new Cyclist("Oz3012", "cyclist", "I. Luke", 44, "WA",0));
		part.add(new SuperAthlete("Oz4001", "super", "T. Fernandez", 18, "NT",0));
		part.add(new SuperAthlete("Oz4002", "super", "C. Bird", 28, "TAS",0));
		part.add(new SuperAthlete("Oz4003", "super", "F. Jalal", 25, "NSW",0));
		part.add(new SuperAthlete("Oz4004", "super", "G. Seow", 26, "SA",0));
		part.add(new SuperAthlete("Oz4005", "super", "D. Chinn", 30, "QLD",0));
		part.add(new SuperAthlete("Oz4006", "super", "P. Lai", 43, "VIC",0));
		part.add(new SuperAthlete("Oz4007", "super", "L. Sade", 36, "NSW",0));
		part.add(new SuperAthlete("Oz4008", "super", "D. Laraine", 29, "QLD",0));
		part.add(new SuperAthlete("Oz4009", "super", "C. Aletta", 24, "VIC",0));
